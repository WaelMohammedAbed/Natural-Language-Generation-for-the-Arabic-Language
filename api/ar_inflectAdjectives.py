...
count=18 # "dual", "plural" or a number (ex: 12)
noun="رجل"
case="nominative" #"nominative", "accusative" or "genitive"
gender = None # 1 male , 0 female
dual = None # the dual form of the noun 
plural = None # the plural form of the noun 
number_format = 2100  #"digitsOnly", "wordsOnly" or a number If count is less than or equal to this value it will be spelled out; otherwise it will be formatted as digits
zero_format = "ولا" #The word used to express a value of 0. Either “صفر”, “اي”, or another word or phrase of your choice, e.g. “لايوجد”.
modifiers=["حنين","جمال"]
agreement=0


countable_noun_printable=countable(count,noun,case,gender,dual,plural,number_format,zero_format,modifiers,agreement)
print("all default: ",countable_noun_printable)
